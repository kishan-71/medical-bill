...
import { cInitialFormState, cFormFields, cFormButton, cTableCol, cTableActions } from "../constants/ClaimRegisterConst";
...
const ClaimRegister = () => {
  ...
  return (
    <div className="p-2">
      <h1 className="text-2xl font-bold mb-1 text-white">Claim Register</h1>
      <p className="text-gray-300 mb-1">This is the Claim Register page.</p>

      <div className="flex justify-end mb-3 items-center">
        <button onClick={openModal} 
          className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
          <IoMdAdd className="inline-block mr-1" />Add Claim</button>
      </div>
