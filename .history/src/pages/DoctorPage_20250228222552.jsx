...
import { initialFormState, DoctorFields, doctorTableCol, doctorTableActions, doctorFormButton } from "../constants/DoctorConst";


const DoctorPage = () => {

  const { data, editItem, formData, loading, isModalOpen, openModal, closeModal,
    handleChange, handleSubmit, handleEdit, handleDelete, } = useCrud(initialFormState, "doctor.php");
 
  const formFields = DoctorFields(formData, handleChange);
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex justify-end mb-4">
        <button
          onClick={openModal}
          className="bg-blue-600 text-white mx-4 py-2 rounded-lg hover:bg-blue-700"
        >
          Add Doctor
        </button>
      </div>
