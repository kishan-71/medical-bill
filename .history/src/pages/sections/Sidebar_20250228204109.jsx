...
const Sidebar = ({ isSidebarOpen }) => {
  const menuItems = [
    ...
    { name: "Bill Register", path: "/bill-register" },
    { name: "Doctor Forwarding", path: "/doctor-forwarding" },
    { name: "Section Amount", path: "/section-amount" },
  ];

  return (
    <aside
      className={`bg-gray-800 w-64 p-4 overflow-y-auto transition-all duration-300 ${
